...
<html lang="tr">
    ...
    <head>
        ...
        <title>Araç Servis - Üye Kaydı</title>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>Araç Servis</strong> Kayıt</h1>
                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                            		...
                            		<p>Kullanıcı adı ve şifrenizi girerek üye kaydı oluşturabilirsiniz:</p>
                        		</div>
                            ...
                            <form action="kayit.php" method="post">
			                        ...
			                        <button type="submit" class="btn btn-success">Kayıt Ol</button><hr>
                                    
			                    </form>
		                    </div>
                            <div class="col-sm-6 col-sm-offset-3 social-login">
                        	<h3>Hesabınız var mı?</h3>
                        	<div class="social-login-buttons">
	                        	<a class="btn btn-link-2" href="girisyap.php">
	                        		<i class=""></i> Giriş Yap
	                        	</a>
