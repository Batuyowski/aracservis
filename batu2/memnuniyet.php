...
include("vtayar.php");
    ...
    $sorgu=$vt->prepare('Select * from servise_gelenler  WHERE servis_giris > DATE_SUB(now(), INTERVAL 5 DAY)');
    $sorgu->execute();
      ...
      <div class="main-panel">        
        <div class="content-wrapper">
          ...
          <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Memnuniyet Araması Yapılacaklar</h4>
                  ...
                  <div class="table-responsive pt-3">
                    ...
                    <td><a href="#" class="btn btn-primary">Arandı</a></td>
